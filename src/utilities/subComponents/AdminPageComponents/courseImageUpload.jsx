...
const ImageUploader = ({navHeight}) => {
    ...
    return (
        <Box sx={{
            ...
            justifyItems: "center", flexDirection: "column", gap: 2, p: 3, borderLeft: { lg: "2px solid white" },
        }}>
            ...
            >
                {selectedIndex !== null && imageUrls[selectedIndex] ? (
                    ...
                    <AddPhotoAlternateIcon sx={{ fontSize: 60, color: "action.active" }} />
                )}
            </Box>
                    ...
                    {imageUrls.map((url, index) => (
                        <Box
                            ...
                            sx={{
                                width: 100,
                                height: 100,
                                border: selectedIndex === index ? "2px solid black" : "1px solid grey",
                                borderRadius: 2,
                                overflow: "hidden",
                                cursor: "pointer",
                                display: "flex",
